...
| `10_Qwen2.5-VL` | Qwen2.5-VL | [2502.13923](https://arxiv.org/abs/2502.13923) | window attention ViT・絶対時間・長尺動画（ACCベースライン） |
| `11_Qwen3-VL` | Qwen3-VL | [2511.21631](https://arxiv.org/abs/2511.21631) | Dense/MoE・Thinking・256K・GUI Agent・3D grounding（ACCベースライン） |
